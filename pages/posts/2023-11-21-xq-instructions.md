...
## <i class="fa-solid fa-code-merge"></i> 版本维护
...
## <i class="fa-regular fa-face-smile-wink"></i> 实验
...
### <i class="fa-solid fa-question"></i> 牌堆因何扁平
...
### <i class="fa-solid fa-exclamation"></i> 如何立体（上）：即时牌并非只有爆发
...
#### <i class="fa-solid fa-shield-cat"></i> 应机牌
...
#### <i class="fa-regular fa-hourglass"></i> 延迟牌
...
### <i class="fa-solid fa-yin-yang"></i>兼容的体力观：体力、体力值与勾玉
...
### <i class="fa-solid fa-arrow-up-right-dots"></i> 递进技
...
### <i class="fa-solid fa-rotate"></i> 翻面与调离的拓展
...
### <i class="fa-solid fa-location-dot"></i> 回合指针
...
### <i class="fa-solid fa-play"></i> 可用性细则：冷却与激活
...
### <i class="fa-solid fa-trophy"></i> 4V4：MOBA游戏的智识或排位赛的遗产
...
### <i class="fa-solid fa-hand-back-fist"></i> 出伤害牌次数
...
### <i class="fa-solid fa-horse"></i> 坐骑及栏位
